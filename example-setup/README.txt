...
HOW TO DEMO:
  ...
  2. Run the different setup flows from the NetsuiteFunctionalTestDriver, or deploy it an a Mule Container:
  	a. CreateEmployeePhoneUpdatesFlow: Creates some price update document in the mongodb. Alternatively, hit
  	http://localhost:9090/netsuite-demo-setup-create-record-updates 
  	b. CreateEmployeesFlow: creates some record in Netsuite. Alternatively, you can hit
