...
public class ItemFulfillmentPackageUpsList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUps[] packageUps;
    ...
    public ItemFulfillmentPackageUpsList(
           org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUps[] packageUps,
           boolean replaceAll) {
     ...
     * @return packageUps
     */
    public org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUps[] getPackageUps() {
        return packageUps;
    }
     ...
     * @param packageUps
     */
    public void setPackageUps(org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUps[] packageUps) {
        this.packageUps = packageUps;
    }

    public org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUps getPackageUps(int i) {
        return this.packageUps[i];
    }

    public void setPackageUps(int i, org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUps _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUpsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "packageUps"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUps"));
