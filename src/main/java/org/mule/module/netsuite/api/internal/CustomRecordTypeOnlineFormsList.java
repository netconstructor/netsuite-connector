...
public class CustomRecordTypeOnlineFormsList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.CustomRecordTypeOnlineForms[] onlineForms;
    ...
    public CustomRecordTypeOnlineFormsList(
           org.mule.module.netsuite.api.internal.CustomRecordTypeOnlineForms[] onlineForms,
           boolean replaceAll) {
     ...
     * @return onlineForms
     */
    public org.mule.module.netsuite.api.internal.CustomRecordTypeOnlineForms[] getOnlineForms() {
        return onlineForms;
    }
     ...
     * @param onlineForms
     */
    public void setOnlineForms(org.mule.module.netsuite.api.internal.CustomRecordTypeOnlineForms[] onlineForms) {
        this.onlineForms = onlineForms;
    }

    public org.mule.module.netsuite.api.internal.CustomRecordTypeOnlineForms getOnlineForms(int i) {
        return this.onlineForms[i];
    }

    public void setOnlineForms(int i, org.mule.module.netsuite.api.internal.CustomRecordTypeOnlineForms _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "CustomRecordTypeOnlineFormsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "onlineForms"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "CustomRecordTypeOnlineForms"));
