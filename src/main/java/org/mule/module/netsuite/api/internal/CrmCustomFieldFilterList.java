...
public class CrmCustomFieldFilterList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.CrmCustomFieldFilter[] filter;
    ...
    public CrmCustomFieldFilterList(
           org.mule.module.netsuite.api.internal.CrmCustomFieldFilter[] filter,
           boolean replaceAll) {
           this.filter = filter;
     ...
     * @return filter
     */
    public org.mule.module.netsuite.api.internal.CrmCustomFieldFilter[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(org.mule.module.netsuite.api.internal.CrmCustomFieldFilter[] filter) {
        this.filter = filter;
    }

    public org.mule.module.netsuite.api.internal.CrmCustomFieldFilter getFilter(int i) {
        return this.filter[i];
    }

    public void setFilter(int i, org.mule.module.netsuite.api.internal.CrmCustomFieldFilter _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "CrmCustomFieldFilterList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "CrmCustomFieldFilter"));
