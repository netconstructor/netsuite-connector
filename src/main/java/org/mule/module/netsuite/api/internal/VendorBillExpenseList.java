...
public class VendorBillExpenseList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.VendorBillExpense[] expense;
    ...
    public VendorBillExpenseList(
           org.mule.module.netsuite.api.internal.VendorBillExpense[] expense,
           boolean replaceAll) {
     ...
     * @return expense
     */
    public org.mule.module.netsuite.api.internal.VendorBillExpense[] getExpense() {
        return expense;
    }
     ...
     * @param expense
     */
    public void setExpense(org.mule.module.netsuite.api.internal.VendorBillExpense[] expense) {
        this.expense = expense;
    }

    public org.mule.module.netsuite.api.internal.VendorBillExpense getExpense(int i) {
        return this.expense[i];
    }

    public void setExpense(int i, org.mule.module.netsuite.api.internal.VendorBillExpense _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2010_2.transactions.webservices.netsuite.com", "VendorBillExpenseList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2010_2.transactions.webservices.netsuite.com", "VendorBillExpense"));
