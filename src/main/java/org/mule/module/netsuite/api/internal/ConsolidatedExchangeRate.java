...
public class ConsolidatedExchangeRate  implements java.io.Serializable {
    ...
    /**
     * Gets the period value for this ConsolidatedExchangeRate.
     * 
     * @return period
     */
    ...
    /**
     * Sets the period value for this ConsolidatedExchangeRate.
     * 
     * @param period
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2010_2.platform.webservices.netsuite.com", "ConsolidatedExchangeRate"));
