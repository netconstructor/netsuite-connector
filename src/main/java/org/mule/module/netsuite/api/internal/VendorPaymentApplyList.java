...
public class VendorPaymentApplyList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.VendorPaymentApply[] apply;
    ...
    public VendorPaymentApplyList(
           org.mule.module.netsuite.api.internal.VendorPaymentApply[] apply,
           boolean replaceAll) {
           this.apply = apply;
     ...
     * @return apply
     */
    public org.mule.module.netsuite.api.internal.VendorPaymentApply[] getApply() {
        return apply;
    }
     ...
     * @param apply
     */
    public void setApply(org.mule.module.netsuite.api.internal.VendorPaymentApply[] apply) {
        this.apply = apply;
    }

    public org.mule.module.netsuite.api.internal.VendorPaymentApply getApply(int i) {
        return this.apply[i];
    }

    public void setApply(int i, org.mule.module.netsuite.api.internal.VendorPaymentApply _value) {
        this.apply[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2010_2.transactions.webservices.netsuite.com", "VendorPaymentApplyList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2010_2.transactions.webservices.netsuite.com", "VendorPaymentApply"));
