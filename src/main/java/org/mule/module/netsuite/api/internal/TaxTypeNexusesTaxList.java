...
public class TaxTypeNexusesTaxList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.TaxTypeNexusesTax[] nexusesTax;
    ...
    public TaxTypeNexusesTaxList(
           org.mule.module.netsuite.api.internal.TaxTypeNexusesTax[] nexusesTax,
           boolean replaceAll) {
     ...
     * @return nexusesTax
     */
    public org.mule.module.netsuite.api.internal.TaxTypeNexusesTax[] getNexusesTax() {
        return nexusesTax;
    }
     ...
     * @param nexusesTax
     */
    public void setNexusesTax(org.mule.module.netsuite.api.internal.TaxTypeNexusesTax[] nexusesTax) {
        this.nexusesTax = nexusesTax;
    }

    public org.mule.module.netsuite.api.internal.TaxTypeNexusesTax getNexusesTax(int i) {
        return this.nexusesTax[i];
    }

    public void setNexusesTax(int i, org.mule.module.netsuite.api.internal.TaxTypeNexusesTax _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "TaxTypeNexusesTaxList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "nexusesTax"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "TaxTypeNexusesTax"));
