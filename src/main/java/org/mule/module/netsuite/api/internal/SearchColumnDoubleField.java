...
public class SearchColumnDoubleField  extends org.mule.module.netsuite.api.internal.SearchColumnField  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2010_2.platform.webservices.netsuite.com", "SearchColumnDoubleField"));
