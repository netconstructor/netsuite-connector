...
public class PurchaseOrderExpenseList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.PurchaseOrderExpense[] expense;
    ...
    public PurchaseOrderExpenseList(
           org.mule.module.netsuite.api.internal.PurchaseOrderExpense[] expense,
           boolean replaceAll) {
     ...
     * @return expense
     */
    public org.mule.module.netsuite.api.internal.PurchaseOrderExpense[] getExpense() {
        return expense;
    }
     ...
     * @param expense
     */
    public void setExpense(org.mule.module.netsuite.api.internal.PurchaseOrderExpense[] expense) {
        this.expense = expense;
    }

    public org.mule.module.netsuite.api.internal.PurchaseOrderExpense getExpense(int i) {
        return this.expense[i];
    }

    public void setExpense(int i, org.mule.module.netsuite.api.internal.PurchaseOrderExpense _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2010_2.transactions.webservices.netsuite.com", "PurchaseOrderExpenseList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2010_2.transactions.webservices.netsuite.com", "PurchaseOrderExpense"));
