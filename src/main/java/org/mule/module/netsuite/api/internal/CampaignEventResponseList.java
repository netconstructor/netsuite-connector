...
public class CampaignEventResponseList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.CampaignEventResponse[] eventResponse;
    ...
    public CampaignEventResponseList(
           org.mule.module.netsuite.api.internal.CampaignEventResponse[] eventResponse,
           boolean replaceAll) {
     ...
     */
    public org.mule.module.netsuite.api.internal.CampaignEventResponse[] getEventResponse() {
        return eventResponse;
    }
     ...
     * @param eventResponse
     */
    public void setEventResponse(org.mule.module.netsuite.api.internal.CampaignEventResponse[] eventResponse) {
        this.eventResponse = eventResponse;
    }

    public org.mule.module.netsuite.api.internal.CampaignEventResponse getEventResponse(int i) {
        return this.eventResponse[i];
    }

    public void setEventResponse(int i, org.mule.module.netsuite.api.internal.CampaignEventResponse _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2010_2.lists.webservices.netsuite.com", "CampaignEventResponseList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:marketing_2010_2.lists.webservices.netsuite.com", "eventResponse"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:marketing_2010_2.lists.webservices.netsuite.com", "CampaignEventResponse"));
