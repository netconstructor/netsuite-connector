...
public class ItemFulfillmentPackageUspsList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUsps[] packageUsps;
    ...
    public ItemFulfillmentPackageUspsList(
           org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUsps[] packageUsps,
           boolean replaceAll) {
     ...
     * @return packageUsps
     */
    public org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUsps[] getPackageUsps() {
        return packageUsps;
    }
     ...
     * @param packageUsps
     */
    public void setPackageUsps(org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUsps[] packageUsps) {
        this.packageUsps = packageUsps;
    }

    public org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUsps getPackageUsps(int i) {
        return this.packageUsps[i];
    }

    public void setPackageUsps(int i, org.mule.module.netsuite.api.internal.ItemFulfillmentPackageUsps _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUspsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "packageUsps"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageUsps"));
