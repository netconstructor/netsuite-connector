/**
 * ContactCategorySearchRowBasic.java
 *
...
public class ContactCategorySearchRowBasic  implements java.io.Serializable {
    ...
    private org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] _private;

    private org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] sync;
    ...
    public ContactCategorySearchRowBasic(
           ...
           org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] _private,
           org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] sync) {
    ...
    /**
     * Gets the internalId value for this ContactCategorySearchRowBasic.
     * 
     * @return internalId
     */
    ...
    /**
     * Sets the internalId value for this ContactCategorySearchRowBasic.
     * 
     * @param internalId
     */
    ...
    /**
     * Gets the isInactive value for this ContactCategorySearchRowBasic.
     * 
     * @return isInactive
     */
    ...
    /**
     * Sets the isInactive value for this ContactCategorySearchRowBasic.
     * 
     * @param isInactive
     */
    ...
    /**
     * Gets the name value for this ContactCategorySearchRowBasic.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this ContactCategorySearchRowBasic.
     * 
     * @param name
     */
    ...
    /**
     * Gets the _private value for this ContactCategorySearchRowBasic.
     * 
     * @return _private
     */
    public org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] get_private() {
        return _private;
    }


    /**
     * Sets the _private value for this ContactCategorySearchRowBasic.
     * 
     * @param _private
     */
    public void set_private(org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] _private) {
        this._private = _private;
    }

    public org.mule.module.netsuite.api.internal.SearchColumnBooleanField get_private(int i) {
        return this._private[i];
    }

    public void set_private(int i, org.mule.module.netsuite.api.internal.SearchColumnBooleanField _value) {
        this._private[i] = _value;
    }


    /**
     * Gets the sync value for this ContactCategorySearchRowBasic.
     * 
     * @return sync
     */
    public org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] getSync() {
        return sync;
    }


    /**
     * Sets the sync value for this ContactCategorySearchRowBasic.
     * 
     * @param sync
     */
    public void setSync(org.mule.module.netsuite.api.internal.SearchColumnBooleanField[] sync) {
        this.sync = sync;
    }

    public org.mule.module.netsuite.api.internal.SearchColumnBooleanField getSync(int i) {
        return this.sync[i];
    }

    public void setSync(int i, org.mule.module.netsuite.api.internal.SearchColumnBooleanField _value) {
        this.sync[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContactCategorySearchRowBasic)) return false;
        ...
        _equals = true && 
            ...
            ((this._private==null && other.get_private()==null) || 
             (this._private!=null &&
              java.util.Arrays.equals(this._private, other.get_private()))) &&
            ((this.sync==null && other.getSync()==null) || 
             (this.sync!=null &&
              java.util.Arrays.equals(this.sync, other.getSync())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (get_private() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(get_private());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(get_private(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getSync() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSync());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSync(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContactCategorySearchRowBasic.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2010_2.platform.webservices.netsuite.com", "ContactCategorySearchRowBasic"));
