...
public class ProjectTaskPredecessorList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.ProjectTaskPredecessor[] projectTaskPredecessor;
    ...
    public ProjectTaskPredecessorList(
           org.mule.module.netsuite.api.internal.ProjectTaskPredecessor[] projectTaskPredecessor,
           boolean replaceAll) {
     ...
     */
    public org.mule.module.netsuite.api.internal.ProjectTaskPredecessor[] getProjectTaskPredecessor() {
        return projectTaskPredecessor;
    }
     ...
     */
    public void setProjectTaskPredecessor(org.mule.module.netsuite.api.internal.ProjectTaskPredecessor[] projectTaskPredecessor) {
        this.projectTaskPredecessor = projectTaskPredecessor;
    }

    public org.mule.module.netsuite.api.internal.ProjectTaskPredecessor getProjectTaskPredecessor(int i) {
        return this.projectTaskPredecessor[i];
    }

    public void setProjectTaskPredecessor(int i, org.mule.module.netsuite.api.internal.ProjectTaskPredecessor _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2010_2.activities.webservices.netsuite.com", "ProjectTaskPredecessorList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:scheduling_2010_2.activities.webservices.netsuite.com", "projectTaskPredecessor"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2010_2.activities.webservices.netsuite.com", "ProjectTaskPredecessor"));
