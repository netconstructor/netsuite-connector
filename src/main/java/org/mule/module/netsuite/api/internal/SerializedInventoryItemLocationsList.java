...
public class SerializedInventoryItemLocationsList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.SerializedInventoryItemLocations[] locations;
    ...
    public SerializedInventoryItemLocationsList(
           org.mule.module.netsuite.api.internal.SerializedInventoryItemLocations[] locations,
           boolean replaceAll) {
     ...
     * @return locations
     */
    public org.mule.module.netsuite.api.internal.SerializedInventoryItemLocations[] getLocations() {
        return locations;
    }
     ...
     * @param locations
     */
    public void setLocations(org.mule.module.netsuite.api.internal.SerializedInventoryItemLocations[] locations) {
        this.locations = locations;
    }

    public org.mule.module.netsuite.api.internal.SerializedInventoryItemLocations getLocations(int i) {
        return this.locations[i];
    }

    public void setLocations(int i, org.mule.module.netsuite.api.internal.SerializedInventoryItemLocations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "SerializedInventoryItemLocationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "SerializedInventoryItemLocations"));
