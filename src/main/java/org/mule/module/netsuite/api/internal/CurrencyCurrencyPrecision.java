...
public class CurrencyCurrencyPrecision implements java.io.Serializable {
    ...
    public static final CurrencyCurrencyPrecision _one = new CurrencyCurrencyPrecision(__one);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2010_2.lists.webservices.netsuite.com", "CurrencyCurrencyPrecision"));
    }
    /**
