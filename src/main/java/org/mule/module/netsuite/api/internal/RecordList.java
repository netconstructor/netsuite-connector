...
public class RecordList  implements java.io.Serializable {
    ...
    public org.mule.module.netsuite.api.internal.Record getRecord(int i) {
        return this.record[i];
    }

    public void setRecord(int i, org.mule.module.netsuite.api.internal.Record _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2010_2.platform.webservices.netsuite.com", "RecordList"));
