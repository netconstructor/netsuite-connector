...
public class CustomRecordTypeTranslationsList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.CustomRecordTypeTranslations[] translations;
    ...
    public CustomRecordTypeTranslationsList(
           org.mule.module.netsuite.api.internal.CustomRecordTypeTranslations[] translations,
           boolean replaceAll) {
     ...
     * @return translations
     */
    public org.mule.module.netsuite.api.internal.CustomRecordTypeTranslations[] getTranslations() {
        return translations;
    }
     ...
     * @param translations
     */
    public void setTranslations(org.mule.module.netsuite.api.internal.CustomRecordTypeTranslations[] translations) {
        this.translations = translations;
    }

    public org.mule.module.netsuite.api.internal.CustomRecordTypeTranslations getTranslations(int i) {
        return this.translations[i];
    }

    public void setTranslations(int i, org.mule.module.netsuite.api.internal.CustomRecordTypeTranslations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "CustomRecordTypeTranslationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "CustomRecordTypeTranslations"));
