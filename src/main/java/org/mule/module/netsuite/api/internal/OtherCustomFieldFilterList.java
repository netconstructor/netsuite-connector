...
public class OtherCustomFieldFilterList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.OtherCustomFieldFilter[] filter;
    ...
    public OtherCustomFieldFilterList(
           org.mule.module.netsuite.api.internal.OtherCustomFieldFilter[] filter,
           boolean replaceAll) {
           this.filter = filter;
     ...
     * @return filter
     */
    public org.mule.module.netsuite.api.internal.OtherCustomFieldFilter[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(org.mule.module.netsuite.api.internal.OtherCustomFieldFilter[] filter) {
        this.filter = filter;
    }

    public org.mule.module.netsuite.api.internal.OtherCustomFieldFilter getFilter(int i) {
        return this.filter[i];
    }

    public void setFilter(int i, org.mule.module.netsuite.api.internal.OtherCustomFieldFilter _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "OtherCustomFieldFilterList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2010_2.setup.webservices.netsuite.com", "OtherCustomFieldFilter"));
