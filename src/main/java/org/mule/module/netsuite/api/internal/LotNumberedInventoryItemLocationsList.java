...
public class LotNumberedInventoryItemLocationsList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.LotNumberedInventoryItemLocations[] locations;
    ...
    public LotNumberedInventoryItemLocationsList(
           org.mule.module.netsuite.api.internal.LotNumberedInventoryItemLocations[] locations,
           boolean replaceAll) {
     ...
     * @return locations
     */
    public org.mule.module.netsuite.api.internal.LotNumberedInventoryItemLocations[] getLocations() {
        return locations;
    }
     ...
     * @param locations
     */
    public void setLocations(org.mule.module.netsuite.api.internal.LotNumberedInventoryItemLocations[] locations) {
        this.locations = locations;
    }

    public org.mule.module.netsuite.api.internal.LotNumberedInventoryItemLocations getLocations(int i) {
        return this.locations[i];
    }

    public void setLocations(int i, org.mule.module.netsuite.api.internal.LotNumberedInventoryItemLocations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "LotNumberedInventoryItemLocationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2010_2.lists.webservices.netsuite.com", "LotNumberedInventoryItemLocations"));
