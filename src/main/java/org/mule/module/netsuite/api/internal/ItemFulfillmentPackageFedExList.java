...
public class ItemFulfillmentPackageFedExList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.ItemFulfillmentPackageFedEx[] packageFedEx;
    ...
    public ItemFulfillmentPackageFedExList(
           org.mule.module.netsuite.api.internal.ItemFulfillmentPackageFedEx[] packageFedEx,
           boolean replaceAll) {
     ...
     * @return packageFedEx
     */
    public org.mule.module.netsuite.api.internal.ItemFulfillmentPackageFedEx[] getPackageFedEx() {
        return packageFedEx;
    }
     ...
     * @param packageFedEx
     */
    public void setPackageFedEx(org.mule.module.netsuite.api.internal.ItemFulfillmentPackageFedEx[] packageFedEx) {
        this.packageFedEx = packageFedEx;
    }

    public org.mule.module.netsuite.api.internal.ItemFulfillmentPackageFedEx getPackageFedEx(int i) {
        return this.packageFedEx[i];
    }

    public void setPackageFedEx(int i, org.mule.module.netsuite.api.internal.ItemFulfillmentPackageFedEx _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageFedExList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "packageFedEx"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2010_2.transactions.webservices.netsuite.com", "ItemFulfillmentPackageFedEx"));
