...
public class EmployeeAddressbookList  implements java.io.Serializable {
    private org.mule.module.netsuite.api.internal.EmployeeAddressbook[] addressbook;
    ...
    public EmployeeAddressbookList(
           org.mule.module.netsuite.api.internal.EmployeeAddressbook[] addressbook,
           boolean replaceAll) {
     ...
     * @return addressbook
     */
    public org.mule.module.netsuite.api.internal.EmployeeAddressbook[] getAddressbook() {
        return addressbook;
    }
     ...
     * @param addressbook
     */
    public void setAddressbook(org.mule.module.netsuite.api.internal.EmployeeAddressbook[] addressbook) {
        this.addressbook = addressbook;
    }

    public org.mule.module.netsuite.api.internal.EmployeeAddressbook getAddressbook(int i) {
        return this.addressbook[i];
    }

    public void setAddressbook(int i, org.mule.module.netsuite.api.internal.EmployeeAddressbook _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2010_2.lists.webservices.netsuite.com", "EmployeeAddressbookList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2010_2.lists.webservices.netsuite.com", "addressbook"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2010_2.lists.webservices.netsuite.com", "EmployeeAddressbook"));
