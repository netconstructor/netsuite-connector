 ...
 *         &lt;element name="isTaxAgency" type="{urn:core_2010_2.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "VendorCategorySearchRowBasic", propOrder = {
    "internalId",
    "isInactive",
    "isTaxAgency",
    "name"
