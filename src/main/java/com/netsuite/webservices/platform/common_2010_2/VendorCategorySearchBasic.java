 ...
 *         &lt;element name="isTaxAgency" type="{urn:core_2010_2.platform.webservices.netsuite.com}SearchBooleanField" minOccurs="0"/>
...
@XmlType(name = "VendorCategorySearchBasic", propOrder = {
    "internalId",
    "internalIdNumber",
    "isInactive",
    "isTaxAgency",
